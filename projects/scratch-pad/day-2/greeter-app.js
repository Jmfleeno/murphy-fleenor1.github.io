...
function greeter(hour) {
    ...
    //if hour is 0-11 console log "Good Morning!"
    if (hour >= 0 && hour <= 11) {
        console.log("Good Morning!");
    //else if hour is 12-16 log "Good Afternoon!"
    } else if (hour >= 12 && hour <= 16) {
        console.log("Good Afternoon!");
    //else if hour is 17-21 log "Good Evening!"
    } else if (hour >= 17 && hour <= 21){
        console.log("Good Evening!");
    //else if hour is 22-24 log "Good Night!"
